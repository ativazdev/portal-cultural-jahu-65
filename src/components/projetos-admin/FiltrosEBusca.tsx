...
export const FiltrosEBusca = ({ filtros, setFiltros, pareceristas }: FiltrosEBuscaProps) => {
      ...
      <div className="grid grid-cols-10 gap-4">
        ...
        <div className="col-span-3">
          <Select value={filtros.parecerista} onValueChange={(value) => setFiltros({ ...filtros, parecerista: value })}>
            ...
            <SelectContent>
              <SelectItem value="Todos">Todos os pareceristas</SelectItem>
