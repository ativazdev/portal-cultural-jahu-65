...
export const PareceristaSolicitarRedefinicaoSenha = () => {
  const { nomePrefeitura } = useParams<{ nomePrefeitura: string }>();
  const { solicitarRedefinicaoSenha, loading } = usePareceristaAuth();
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            ...
            <Link to={`/${nomePrefeitura}/parecerista/login`}>
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            <Link
              to={`/${nomePrefeitura}/parecerista/login`}
