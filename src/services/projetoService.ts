...
export interface ProjetoWithDetails extends Projeto {
  ...
  proponente: {
    ...
    funcao_artistica_responsavel?: string;
    profissao_responsavel?: string;
    mini_curriculo_responsavel?: string;
    genero_responsavel?: string;
    raca_responsavel?: string;
    escolaridade_responsavel?: string;
    renda_mensal_responsavel?: string;
    pcd_responsavel?: boolean;
    tipo_deficiencia_responsavel?: string;
    programa_social_responsavel?: string;
    concorre_cotas_responsavel?: boolean;
    tipo_cotas_responsavel?: string;
    comunidade_tradicional_responsavel?: string;
